      ...
      <Container size="xl">
        ...
        >
          <Textarea
            ...
            autosize
            onKeyDown={(e) => {
              if (e.keyCode == 13 && !e.shiftKey && value.trim().length > 3) {
                e.preventDefault();
                sendReview();
              }
            }}
        ...
        <Title align="center" pl={20} pt={50} order={3}>
          {comments.length > 0 ? "Отзывы" : "На данный товар еще нет отзывов"}
        </Title>
        ...
        >
          <Container mb={50} size="sm">
            ...
            <List spacing="sm">
              <List.Item>
                <Kbd>⌘ + B/ Ctrl + B</Kbd> — переключить жирный шрифт в текущем
                выделении
              </List.Item>
              <List.Item>
                <Kbd>⌘ + I/ Ctrl + I</Kbd> — переключить курсив в текущем
                выделении
              </List.Item>
              <List.Item>
                <Kbd>⌘ + U/ Ctrl + U</Kbd> — переключить формат подчеркивания в
                текущем выделении
              </List.Item>
            </List>
          </Container>
