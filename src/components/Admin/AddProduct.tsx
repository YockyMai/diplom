  ...
  return (
    <div>
      <Alert title="Добавить товар" icon={<CirclePlus />}>
        <Text>
          Добавьте товар, который будет отображаться в каталоге у пользователей
        </Text>
      ...
      >
        <Stack>
          ...
          />
          <NumberInput
            error={price > 100000 && "Значение должно быть меньше 100.000 ₽"}
            value={price}
          ...
          <Button style={{ height: "80px" }} mt={30} onClick={addProduct}>
            Добавть товар!
          </Button>
        </Stack>
      </Modal>
      ...
      >
        ...
        <Stack>
          <Button disabled={sizes.length <= 0} mt={30} onClick={createSizes}>
            Готово!
          </Button>
        </Stack>
      </Modal>
