        ...
        <Grid grow align="center" justify="center">
                ...
                <Container size="lg">
                  ...
                  <Card.Section pb={10}>
                    <Group align="center">
                      ...
                      Средний рейтинг:
                      {item.rating ? item.rating : "не оцененно"}
                      <Popover
                        ...
                        target={
                          <InfoCircle
                            ...
                            onMouseEnter={() => setShowRatingInfo(true)}
                            onMouseLeave={() => setShowRatingInfo(false)}
                          />
                        }
                      >
                        <Text>
                          Поставить рейтинг можно, написав любой комментарий
                          ниже, или на странице "Корзина" в разделе "Ваши
                          заказы"
                        </Text>
                      </Popover>
                    </Group>
                  ...
                  <Card.Section py={15}>
                    <Group>
                      <Title
                        sx={{
                          textDecoration: item.discountPrice
                            ? "line-through"
                            : "none",
                        }}
                        order={2}
                      >
                        {currencyStringsFormatter.format(item.price)}
                      </Title>
                      {item.discountPrice && (
                        <Title order={2}>
                          {currencyStringsFormatter.format(item.discountPrice)}
                        </Title>
                      )}
                    </Group>
                  </Card.Section>
                  ...
                  <Card.Section>
                    <Group>
                      <Text>
                        <>
                          <Mark color="teal">Категории:</Mark> {item.brand.name}
                          ,{item.type.name}
                        </>
                      </Text>
                    </Group>
          ...
          <Grid.Col span={12}>
            <Tabs mt="xl">
              ...
              <Tabs.Tab label="Информация о товаре" icon={<InfoCircle />}>
