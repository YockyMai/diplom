  ...
  return (
    <Container size="xl">
      <Group position="apart" mt={100} align="center">
        ...
        >
          <List.Item>
            Большой выбор оригинальной спортивной обуви, одежды и аксессуаров
            мировых торговых марок. Гарантия отсутствия подделок;
          </List.Item>
          <List.Item>
            Лояльная ценовая политика, направленная на то, чтобы дать
            возможность покупателям приобретать наши товарные позиции выгодно;
          </List.Item>
          <List.Item>
            Все реализуемые изделия проверяются в аутентификационном центре;
          </List.Item>
          <List.Item>
            Своим покупателям мы гарантируем оригинальность, надёжность и
            функциональность всех реализуемых товаров;
          </List.Item>
          <List.Item>
            Оперативная обработка заказов, и их быстрая доставка;
          </List.Item>
          <List.Item>
            Индивидуальный подход и помощь в подборе необходимых товаров.
          </List.Item>
        </List>
      </Group>
