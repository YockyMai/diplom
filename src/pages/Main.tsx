...
import {
	...
	Title,
	Text,
	Stack, List, Center, Button, Alert,
} from '@mantine/core';
      ...
      <Stack style={{textAlign: 'center'}}>
        ...
        <CatalogLinkCards/>
			...
			<Container mt={80} size={"sm"}>
				<Alert title={
					<Text align={"center"} weight={900} >Зарегистрируйтесь на нашем сайти и получите следующие преимущества:</Text>
				}>
					<Stack align={"left"} mt="xl">
						...
						<Button mb={"sm"} leftIcon={<UserCircle/>} component={Link} to={"/auth/signup"} m={"auto"}>
							Зарегистрироваться
						</Button>
					</Stack>
				</Alert>
